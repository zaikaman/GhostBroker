...
export async function seedCompletedTradeAndReceipt() {
  ...
  const trade = {
    ...
    asset_code_ciphertext: 't3cipher.asset.us3_longer_ciphertext_hash_sealed',
    quantity_ciphertext: 't3cipher.quantity.us3_longer_ciphertext_hash_sealed',
    execution_price_ciphertext: 't3cipher.execution.us3_longer_ciphertext_hash_sealed',
