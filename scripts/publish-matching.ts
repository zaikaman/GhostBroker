 ...
 *   - T3_MATCHING_CONTRACT_VERSION       defaults to "0.1.0"
 */
...
async function main(): Promise<void> {
  ...
  const version = env.T3_MATCHING_CONTRACT_VERSION ?? "0.1.0";
  const tail = "matching";
  ...
  try {
    ...
    console.log(`  /contracts/${tail}/blind-intents and /contracts/${tail}/evaluate`);
