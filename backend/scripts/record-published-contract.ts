 ...
 *   - T3_MATCHING_CONTRACT_VERSION       defaults to "0.10.0"
 *   - T3_MATCHING_CONTRACT_VERSION       defaults to "0.10.1"
 *
 * Run from the workspace root:
 *   npx tsx backend/scripts/record-published-contract.ts
 *
 * Override the version with:
 *   T3_MATCHING_CONTRACT_VERSION=0.10.1 npx tsx backend/scripts/record-published-contract.ts
 */
